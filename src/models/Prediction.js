...
class Prediction {
    ...
    static get PREDEFINED_CLASS_ABBR() {
        return {
            ...
            'STANDING AND TYPING ON A KEYBOARD': 'Stand 💻',
    ...
    static get PREDEFINED_CLASS_TEXT() {
        return {
            ...
            'LYING': 'lying',
            'SITTING': 'sitting',
            'SITTING AND TYPING ON A KEYBOARD': 'sitting and using computer',
            'SITTING AND WRITING': 'sitting and writing',
            'STANDING AND TYPING ON A KEYBOARD': 'standing and using computer',
